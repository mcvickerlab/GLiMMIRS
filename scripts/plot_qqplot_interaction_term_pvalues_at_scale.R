...
enhancer.enhancer.pvalues <- read.csv('/iblm/netapp/data1/external/Gasperini2019/processed/enhancer_enhancer_at_scale_20_cells_model.csv')
...
create.scatterplot(
    ...
    filename = '/iblm/netapp/home/karthik/crisprQTL/plots/interaction_term_at_scale_qqplot.png',
    resolution = 200,
    add.xyline = TRUE,
