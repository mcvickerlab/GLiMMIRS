...
# Gasperini et al. in 2019., but scrambles the guide indicator vectors to generate a null
# distribution of p-values. This program was written by Karthik Guruvayurappan.
...
write.csv(
    pvalue.table,
    '/iblm/netapp/data1/external/Gasperini2019/processed/23_01_12_enhancer_gene_pairs_suppl_table_2_baseline_pseudocount_model_neg_scrambled_guides.csv',
    row.names = FALSE
)
