...
interaction.pvalues <- read.csv('/iblm/netapp/home/karthik/GLiMMIRS/data/experimental/processed/23_11_14_interaction_adjusted_pvalues_ptprc.csv')
interaction.pvalues$color <- 'black'
interaction.pvalues$color[interaction.pvalues$x < 0.1] <- 'red'
...
ggsave(
    filename = '/iblm/netapp/home/karthik/GLiMMIRS/out/23_11_14_interaction_pvalue_ptprc_qqplot.png',
    device = 'png',
    plot = plot
)